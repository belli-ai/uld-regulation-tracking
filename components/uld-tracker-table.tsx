...
export function UldTrackerTable({ rows }: Props) {
  ...
  return (
    <Table>
      <TableHeader>
        <TableRow className="border-b border-border/80 bg-background/55 hover:bg-background/55">
          <TableHead>
            <button
              type="button"
        ...
        {sortedRows.length > 0 ? (
          sortedRows.map((row) => (
            <TableRow
              ...
              className={cn(
                "cursor-pointer border-border/70 bg-background/20 transition-colors",
