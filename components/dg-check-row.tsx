  ...
  return (
    ...
    >
      ...
      <CardContent className="flex flex-col gap-3">
        {rejection ? (
          <div className="rounded-xl border border-red-500/50 bg-red-500/10 p-3 text-sm text-red-100">
            ...
            {pieces.map((piece) => {
              ...
              return (
                <div
                  key={piece['@id']}
                  className={cn(
                    'flex min-h-11 flex-col gap-2 rounded-xl border px-3 py-3 text-sm',
                    toneClass,
                  )}
                >
